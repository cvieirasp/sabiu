...
### Issue #1: Implementar API routes para Items
...
### Issue #2: Criar formulário de Item com Markdown
...
### Issue #3: Implementar gestão de módulos
...
### Issue #4: Implementar sistema de dependências
...
### Issue #5: Criar página de listagem com filtros
